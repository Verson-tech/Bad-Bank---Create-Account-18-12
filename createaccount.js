  ...
  return (
    <Card
      ...
      body={show ? (  
              ...
              Password<br/>
              <input type="password" className="form-control" id="password" placeholder="Enter password min 8" value={password} onChange={e => setPassword(e.currentTarget.value)}/><br/>
